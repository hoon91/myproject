...
<script>
	...
	$(document).on('click', '#btnUpdate', function(){
		var url = "/board/boardUpdate";
		url = url + "?bno="+${boardView.bno};
		location.href = url;
	});
	...
	function replyList(){
		 ...
		 $.getJSON("/board/replyList" + "?bno=" + bno, function(data){
		  var str = "";
	...
	<div class="container">
			...
			<c:if test="${member != null}">
				...
				<div class="board_info_box">
					...
					<c:out value="${boardView.writer}"/></span>
					
					<i class="fa fa-clock-o" aria-hidden="true"></i>
					<span class="board_date"><fmt:formatDate value="${boardView.regdate}"  pattern="yy-MM-dd hh:mm"/></span>
					
					<i class="fa fa-eye" aria-hidden="true"></i>
					<span class="board_view_cnt"><c:out value="${boardView.viewCnt}"/></span>
				</div>
				
				<div class="board_content">${boardView.content}</div>
				<div class="board_tag">TAG : <a><c:out value="${boardView.tag}"/></a></div>
