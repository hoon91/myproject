...
<script>
	...
	$(document).on('click', '#btnList', function(){
		location.href = "/travel/travelList?page=${scri.page}"
	...
	$(document).on('click', '#btnUpdate', function(){
		var url = "/travel/travelUpdate";
		url = url + "?bno="+${travelView.bno};
		location.href = url;
	});
	...
	function fn_fileDown(fileNo){
		...
		formObj.attr("action", "/travel/fileDown");
		formObj.submit();
	}
	
	function replyList(){
		 var bno = ${travelView.bno};
		 $.getJSON("/travel/replyList" + "?bno=" + bno, function(data){
		  var str = "";
...
<header id="header">
	...
	<div class="container">
			<form name="readForm" role="form" method="post">
  				<input type="hidden" id="bno" name="bno" value="${travelView.bno}" />
			...
			<c:if test="${member != null}">
				<div class="board_title"><c:out value="${travelView.title}"/></div>
				<div class="board_info_box">
					<span class="board_writer">
					<i class="fa fa-user-circle-o" aria-hidden="true"></i>
					<c:out value="${travelView.writer}"/></span>
					
					<i class="fa fa-clock-o" aria-hidden="true"></i>
					<span class="board_date"><fmt:formatDate value="${travelView.regdate}"  pattern="yy-MM-dd hh:mm"/></span>
					
					<i class="fa fa-eye" aria-hidden="true"></i>
					<span class="board_view_cnt"><c:out value="${travelView.viewCnt}"/></span>
				</div>
				
				<div class="board_content">${travelView.content}</div>
				<div class="board_tag">TAG : <a><c:out value="${travelView.tag}"/></a></div>
			...
			<div style="margin-top : 20px">
				<c:if test="${member.userid == travelView.writer}">
...
<div id="reply">
 ...
 <section class="replyForm">
  ...
  <input type="hidden" name="bno" id="bno" value="${travelView.bno}">
   <div class="mb-3">
