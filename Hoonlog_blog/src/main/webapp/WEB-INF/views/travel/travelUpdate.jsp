...
<script>
	...
	$(document).ready(function(){
		...
		$("#btnCancel").on("click", function(){
			...
			location.href = "/travel/travelView?bno=${update.bno}"
				   + "&page=${scri.page}"
		...
		$("#btnSave").on("click", function(){
			formObj.attr("action", "/travel/travelUpdate?bno="+${update.bno});
	...
	$(document).on('click', '#btnList', function(){
		location.href="/travel/travelList?bno={update.bno}"
				+ "&page=${scri.page}"
			    + "&perPageNum=${scri.perPageNum}"
			    + "&searchType=${scri.searchType}"
			    + "&keyword=${scri.keyword}";
...
<header id="header">
	<%@ include file="../include/header.jsp" %>
		...
		<div class="container" role="main">
			<form id="form" name="updateForm" method="post" action="/travel/travelUpdate" enctype="multipart/form-data">
