...
<header class="header">
	...
	<div class="container">
			<h1 align="center" style="margin-bottom: 30px;">DIARY</h1>
		<hr>
				...
				<c:choose>
					...
					<c:forEach items="${diaryList}" var = "list">
						<tr>
							...
							<td>
								<a href="/diary/diaryView?bno=${list.bno}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}">
		...
		<div align ="center">
  			<ul class="pagination justify-content-center">
    			...
    			<li class="page-item"><a href="/diary/diaryList${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
   				</c:if> 

    			<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="idx">
    			<li class="page-item"><a href="/diary/diaryList${pageMaker.makeSearch(idx)}">${idx}</a></li>
    			</c:forEach>

    			<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
    			<li class="page-item"><a href="/diary/diaryList${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
    			</c:if> 
  			</ul>
		</div>
