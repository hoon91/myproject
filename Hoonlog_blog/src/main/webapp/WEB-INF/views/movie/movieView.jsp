...
<script>
	...
	$(document).on('click', '#btnList', function(){
		location.href = "/movie/movieList?page=${scri.page}"
	...
	$(document).on('click', '#btnUpdate', function(){
		var url = "/movie/movieUpdate";
		url = url + "?bno="+${movieView.bno};
		location.href = url;
	});
	...
	function fn_fileDown(fileNo){
		...
		formObj.attr("action", "/movie/fileDown");
		formObj.submit();
	}
	
	function replyList(){
		 var bno = ${movieView.bno};
		 $.getJSON("/movie/replyList" + "?bno=" + bno, function(data){
		  var str = "";
...
<header id="header">
	...
	<div class="container">
			<form name="readForm" role="form" method="post">
  				...
  				<input type="hidden" id="bno" name="bno" value="${movieView.bno}" />
			...
			<c:if test="${member != null}">
				<div class="board_title"><c:out value="${movieView.title}"/></div>
				<div class="board_info_box">
					<span class="board_writer">
					<i class="fa fa-user-circle-o" aria-hidden="true"></i>
					<c:out value="${movieView.writer}"/></span>
					
					<i class="fa fa-clock-o" aria-hidden="true"></i>
					<span class="board_date"><fmt:formatDate value="${movieView.regdate}"  pattern="yy-MM-dd hh:mm"/></span>
					
					<i class="fa fa-eye" aria-hidden="true"></i>
					<span class="board_view_cnt"><c:out value="${movieView.viewCnt}"/></span>
				</div>
				
				<div class="board_content">${movieView.content}</div>
				<div class="board_tag">TAG : ${movieView.tag}</div>
			...
			<div style="margin-top : 20px">
				<c:if test="${member.userid == movieView.writer}">
...
<div id="reply">
 ...
 <section class="replyForm">
  ...
  <input type="hidden" name="bno" id="bno" value="${movieView.bno}">
   <div class="mb-3">
