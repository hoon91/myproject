...
<script>
	...
	$(document).on('click', '#btnList', function(){
		location.href = "/it/itList?page=${scri.page}"
	...
	function fn_fileDown(fileNo){
		...
		formObj.attr("action", "/it/fileDown");
		formObj.submit();
	}
	
	function replyList(){
		 var bno = ${itView.bno};
		 $.getJSON("/it/replyList" + "?bno=" + bno, function(data){
		  var str = "";
...
<header id="header">
	...
	<div class="container">
			<form name="readForm" role="form" method="post">
  				...
  				<input type="hidden" id="bno" name="bno" value="${itView.bno}" />
			...
			<c:if test="${member != null}">
				<div class="board_title"><c:out value="${itView.title}"/></div>
				<div class="board_info_box">
					<span class="board_writer">
					<i class="fa fa-user-circle-o" aria-hidden="true"></i>
					<c:out value="${itView.writer}"/></span>
					
					<i class="fa fa-clock-o" aria-hidden="true"></i>
					<span class="board_date"><fmt:formatDate value="${itView.regdate}"  pattern="yy-MM-dd hh:mm"/></span>
					
					<i class="fa fa-eye" aria-hidden="true"></i>
					<span class="board_view_cnt"><c:out value="${itView.viewCnt}"/></span>
				</div>
				
				<div class="board_content">${itView.content}</div>
				<div class="board_tag">TAG : <a><c:out value="${itView.tag}"/></a></div>
			...
			<div style="margin-top : 20px">
				<c:if test="${member.userid == itView.writer}">
...
<div id="reply">
 ...
 <section class="replyForm">
  ...
  <input type="hidden" name="bno" id="bno" value="${itView.bno}">
   <div class="mb-3">
